...
type BusPriceTriggerStrategyInstance struct {
	...
	OpenPrice  string    `json:"openPrice" gorm:"type:decimal(32,0);comment:开仓价格"`
	ClosePrice string    `json:"closePrice" gorm:"type:varchar(255);comment:平仓价格"`
	Amount     string    `json:"amount" gorm:"type:decimal(32,0);comment:开仓数量"`
