...
type GetStateResponse struct {
	...
	InstanceError        string                 `protobuf:"bytes,9,opt,name=instance_error,json=instanceError,proto3" json:"instance_error,omitempty"`                      // 实例错误信息
	InstanceTaskState    *InstanceTaskState     `protobuf:"bytes,10,opt,name=instance_task_state,json=instanceTaskState,proto3,oneof" json:"instance_task_state,omitempty"` // 实例任务状态
	WaterLevelStatus     int32                  `protobuf:"varint,11,opt,name=water_level_status,json=waterLevelStatus,proto3" json:"water_level_status,omitempty"`         // 0-初始状态 1-水位调节中
	TraderSwitchDesc     string                 `protobuf:"bytes,12,opt,name=trader_switch_desc,json=traderSwitchDesc,proto3" json:"trader_switch_desc,omitempty"`          // 交易开关描述
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *GetStateResponse) GetInstanceError() string {
	if x != nil {
		return x.InstanceError
	}
	return ""
}

func (x *GetStateResponse) GetInstanceTaskState() *InstanceTaskState {
	if x != nil {
		return x.InstanceTaskState
	}
	return nil
}

func (x *GetStateResponse) GetWaterLevelStatus() int32 {
	if x != nil {
		return x.WaterLevelStatus
	}
	return 0
}

func (x *GetStateResponse) GetTraderSwitchDesc() string {
	if x != nil {
		return x.TraderSwitchDesc
	}
	return ""
}

type InstanceTaskState struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TaskType      string                 `protobuf:"bytes,1,opt,name=task_type,json=taskType,proto3" json:"task_type,omitempty"`       // 任务类型
	TaskStep      string                 `protobuf:"bytes,2,opt,name=task_step,json=taskStep,proto3" json:"task_step,omitempty"`       // 任务步骤
	TaskStatus    string                 `protobuf:"bytes,3,opt,name=task_status,json=taskStatus,proto3" json:"task_status,omitempty"` // 任务状态
	TaskError     string                 `protobuf:"bytes,4,opt,name=task_error,json=taskError,proto3" json:"task_error,omitempty"`    // 任务错误信息
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *InstanceTaskState) Reset() {
	*x = InstanceTaskState{}
...
func (x *InstanceTaskState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InstanceTaskState) ProtoMessage() {}

func (x *InstanceTaskState) ProtoReflect() protoreflect.Message {
	mi := &file_water_level_service_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InstanceTaskState.ProtoReflect.Descriptor instead.
func (*InstanceTaskState) Descriptor() ([]byte, []int) {
	return file_water_level_service_proto_rawDescGZIP(), []int{7}
}

func (x *InstanceTaskState) GetTaskType() string {
	if x != nil {
		return x.TaskType
	}
	return ""
...
func (x *InstanceTaskState) GetTaskStep() string {
	if x != nil {
		return x.TaskStep
	}
	return ""
...
func (x *InstanceTaskState) GetTaskStatus() string {
	if x != nil {
		return x.TaskStatus
	}
	return ""
...
func (x *InstanceTaskState) GetTaskError() string {
	if x != nil {
		return x.TaskError
	}
	return ""
...
func (x *GetPortfolioUnwindingResponse) Reset() {
	*x = GetPortfolioUnwindingResponse{}
	mi := &file_water_level_service_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetPortfolioUnwindingResponse) Descriptor() ([]byte, []int) {
	return file_water_level_service_proto_rawDescGZIP(), []int{11}
}
...
type GetInterestRatesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ExchangeType  ExchangeType           `protobuf:"varint,1,opt,name=exchange_type,json=exchangeType,proto3,enum=water_level_service.ExchangeType" json:"exchange_type,omitempty"`
	SecretKey     *SecretKey             `protobuf:"bytes,2,opt,name=secret_key,json=secretKey,proto3" json:"secret_key,omitempty"` // 交易所的api-key，secret，passphrase 以及 chain wallet private key
	Currencies    []string               `protobuf:"bytes,3,rep,name=currencies,proto3" json:"currencies,omitempty"`                // 需要查询的币种列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetInterestRatesRequest) Reset() {
	*x = GetInterestRatesRequest{}
	mi := &file_water_level_service_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetInterestRatesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetInterestRatesRequest) ProtoMessage() {}

func (x *GetInterestRatesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_water_level_service_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetInterestRatesRequest.ProtoReflect.Descriptor instead.
func (*GetInterestRatesRequest) Descriptor() ([]byte, []int) {
	return file_water_level_service_proto_rawDescGZIP(), []int{12}
}

func (x *GetInterestRatesRequest) GetExchangeType() ExchangeType {
	if x != nil {
		return x.ExchangeType
	}
	return ExchangeType_Unknown
...
func (x *GetInterestRatesRequest) GetSecretKey() *SecretKey {
	if x != nil {
		return x.SecretKey
	}
	return nil
...
func (x *GetInterestRatesRequest) GetCurrencies() []string {
	if x != nil {
		return x.Currencies
	}
	return nil
...
type GetInterestRatesResponse struct {
	state         protoimpl.MessageState                   `protogen:"open.v1"`
	List          []*GetInterestRatesResponse_InterestRate `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetInterestRatesResponse) Reset() {
	*x = GetInterestRatesResponse{}
	mi := &file_water_level_service_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetInterestRatesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetInterestRatesResponse) ProtoMessage() {}

func (x *GetInterestRatesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_water_level_service_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetInterestRatesResponse.ProtoReflect.Descriptor instead.
func (*GetInterestRatesResponse) Descriptor() ([]byte, []int) {
	return file_water_level_service_proto_rawDescGZIP(), []int{13}
}

func (x *GetInterestRatesResponse) GetList() []*GetInterestRatesResponse_InterestRate {
	if x != nil {
		return x.List
	}
	return nil
...
type GetInterestRatesResponse_InterestRate struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetInterestRatesResponse_InterestRate) Reset() {
	*x = GetInterestRatesResponse_InterestRate{}
	mi := &file_water_level_service_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetInterestRatesResponse_InterestRate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetInterestRatesResponse_InterestRate) ProtoMessage() {}

func (x *GetInterestRatesResponse_InterestRate) ProtoReflect() protoreflect.Message {
	mi := &file_water_level_service_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetInterestRatesResponse_InterestRate.ProtoReflect.Descriptor instead.
func (*GetInterestRatesResponse_InterestRate) Descriptor() ([]byte, []int) {
	return file_water_level_service_proto_rawDescGZIP(), []int{13, 0}
}

func (x *GetInterestRatesResponse_InterestRate) GetCurrency() string {
	if x != nil {
		return x.Currency
	}
	return ""
...
func (x *GetInterestRatesResponse_InterestRate) GetInterestRate() string {
	if x != nil {
...
var file_water_level_service_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x0a, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x22, 0x96,
	0x05, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	,
	...
	,
	...
	0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x70, 0x69, 0x5f, 0x6b,
	...
	,
	...
	,
...
var file_water_level_service_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_water_level_service_proto_goTypes = []any{
	...
	(*InstanceTaskState)(nil),                     // 9: water_level_service.InstanceTaskState
	(*SecretKey)(nil),                             // 10: water_level_service.SecretKey
	(*ExchangeAccount)(nil),                       // 11: water_level_service.ExchangeAccount
	(*PortfolioUnwindingRequest)(nil),             // 12: water_level_service.PortfolioUnwindingRequest
	(*GetPortfolioUnwindingResponse)(nil),         // 13: water_level_service.GetPortfolioUnwindingResponse
	(*GetInterestRatesRequest)(nil),               // 14: water_level_service.GetInterestRatesRequest
	(*GetInterestRatesResponse)(nil),              // 15: water_level_service.GetInterestRatesResponse
	(*GetInterestRatesResponse_InterestRate)(nil), // 16: water_level_service.GetInterestRatesResponse.InterestRate
...
var file_water_level_service_proto_depIdxs = []int32{
	...
	10, // 2: water_level_service.StartInstanceRequest.secret_key:type_name -> water_level_service.SecretKey
	...
	9,  // 6: water_level_service.GetStateResponse.instance_task_state:type_name -> water_level_service.InstanceTaskState
	11, // 7: water_level_service.SecretKey.trader_account:type_name -> water_level_service.ExchangeAccount
	11, // 8: water_level_service.SecretKey.master_account:type_name -> water_level_service.ExchangeAccount
	1,  // 9: water_level_service.PortfolioUnwindingRequest.exchange_type:type_name -> water_level_service.ExchangeType
	10, // 10: water_level_service.PortfolioUnwindingRequest.secret_key:type_name -> water_level_service.SecretKey
	1,  // 11: water_level_service.GetInterestRatesRequest.exchange_type:type_name -> water_level_service.ExchangeType
	10, // 12: water_level_service.GetInterestRatesRequest.secret_key:type_name -> water_level_service.SecretKey
	16, // 13: water_level_service.GetInterestRatesResponse.list:type_name -> water_level_service.GetInterestRatesResponse.InterestRate
	2,  // 14: water_level_service.Instance.StartInstance:input_type -> water_level_service.StartInstanceRequest
	5,  // 15: water_level_service.Instance.UpdateInstanceParams:input_type -> water_level_service.UpdateInstanceParamsRequest
	7,  // 16: water_level_service.Instance.StopInstance:input_type -> water_level_service.InstanceId
	17, // 17: water_level_service.Instance.ListInstances:input_type -> google.protobuf.Empty
	7,  // 18: water_level_service.Instance.GetInstanceState:input_type -> water_level_service.InstanceId
	12, // 19: water_level_service.Instance.GetPortfolioUnwindingInfo:input_type -> water_level_service.PortfolioUnwindingRequest
	12, // 20: water_level_service.Instance.PortfolioUnwinding:input_type -> water_level_service.PortfolioUnwindingRequest
	14, // 21: water_level_service.Instance.GetInterestRates:input_type -> water_level_service.GetInterestRatesRequest
	7,  // 22: water_level_service.Instance.StartInstance:output_type -> water_level_service.InstanceId
	17, // 23: water_level_service.Instance.UpdateInstanceParams:output_type -> google.protobuf.Empty
	17, // 24: water_level_service.Instance.StopInstance:output_type -> google.protobuf.Empty
	6,  // 25: water_level_service.Instance.ListInstances:output_type -> water_level_service.InstanceListResponse
	8,  // 26: water_level_service.Instance.GetInstanceState:output_type -> water_level_service.GetStateResponse
	13, // 27: water_level_service.Instance.GetPortfolioUnwindingInfo:output_type -> water_level_service.GetPortfolioUnwindingResponse
	17, // 28: water_level_service.Instance.PortfolioUnwinding:output_type -> google.protobuf.Empty
	15, // 29: water_level_service.Instance.GetInterestRates:output_type -> water_level_service.GetInterestRatesResponse
...
func file_water_level_service_proto_init() {
	...
	file_water_level_service_proto_msgTypes[6].OneofWrappers = []any{}
	file_water_level_service_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
