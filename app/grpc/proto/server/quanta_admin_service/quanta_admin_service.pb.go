...
type GetInstanceConfigResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	InstanceId    *string                `protobuf:"bytes,1,req,name=instance_id,json=instanceId" json:"instance_id,omitempty"`
	Configs       []*InstanceConfig      `protobuf:"bytes,2,rep,name=configs" json:"configs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type InstanceConfig struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ParamKey      *string                `protobuf:"bytes,1,req,name=param_key,json=paramKey" json:"param_key,omitempty"`
	ParamValue    *string                `protobuf:"bytes,2,req,name=param_value,json=paramValue" json:"param_value,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetStartOrStopFlagResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	InstanceId    *string                `protobuf:"bytes,1,req,name=instance_id,json=instanceId" json:"instance_id,omitempty"`
...
func (x *GetStartOrStopFlagResponse) Reset() {
	*x = GetStartOrStopFlagResponse{}
	mi := &file_quanta_admin_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetStartOrStopFlagResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetStartOrStopFlagResponse) ProtoMessage() {}

func (x *GetStartOrStopFlagResponse) ProtoReflect() protoreflect.Message {
	mi := &file_quanta_admin_service_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetStartOrStopFlagResponse.ProtoReflect.Descriptor instead.
func (*GetStartOrStopFlagResponse) Descriptor() ([]byte, []int) {
	return file_quanta_admin_service_proto_rawDescGZIP(), []int{3}
}

func (x *GetStartOrStopFlagResponse) GetInstanceId() string {
	if x != nil && x.InstanceId != nil {
		return *x.InstanceId
	}
	return ""
...
func (x *GetStartOrStopFlagResponse) GetFlag() bool {
	if x != nil && x.Flag != nil {
		return *x.Flag
	}
	return false
...
var file_quanta_admin_service_proto_rawDesc = []byte{
	...
	0x5f, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x02, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x72, 0x61,
	0x6d, 0x4b, 0x65, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x5f, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x02, 0x28, 0x09, 0x52, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x51, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x72,
	0x74, 0x4f, 0x72, 0x53, 0x74, 0x6f, 0x70, 0x46, 0x6c, 0x61, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	,
}
...
var file_quanta_admin_service_proto_goTypes = []any{
	...
	(*GetStartOrStopFlagResponse)(nil), // 3: grpc_service.GetStartOrStopFlagResponse
}
var file_quanta_admin_service_proto_depIdxs = []int32{
	...
	3, // 4: grpc_service.QuantaAdmin.GetStartOrStopFlag:output_type -> grpc_service.GetStartOrStopFlagResponse
